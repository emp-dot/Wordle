...
class KeyboardCell: UICollectionViewCell {
  ...
  func configure(with string: String) {
    ...
    */
    ...
    self.string = string // Assigning the argument `string` to the private property `self.string`
    label?.text = self.string // Changing the text of the label to the value of the passed-in string
    // END YOUR CODE HERE
  }
